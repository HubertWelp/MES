...
void (*MQTTNode::msgRcvdCallback)(char*, char*, int) = NULL;
...
//    fclose(file);
    ...
    if(msgRcvdCallback)
        msgRcvdCallback(topicName, payloadbuffer,message->payloadlen);
//    printf("%s\n",payloadbuffer);
...
void MQTTNode::setMsgRcvdCallback(void (*callback)(char*, char*, int))
{
    MQTTNode::msgRcvdCallback = callback;
}
